...
public class ArticleAjout extends JFrame {
	...
	public ArticleAjout( ) {
		...
		ArticleBase db_article=new ArticleBase();
		...
		btnAjouter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Article article=new Article(0,designation.getText(),reference.getText(),Float.parseFloat(prixunitaire.getText()), Float.parseFloat(prixTTC.getText()) , Float.parseFloat(QteStock.getText()),Float.parseFloat(QteMin.getText()), codeAbarre.getText(),id_famille,id_taxe);
				db_article.AjoutArticle(article);
				ArticleInternalFrame.mytablemodel.fireTableDataChanged();
				ArticleInternalFrame.mytablemodel.fireTableStructureChanged();
			}
		});
