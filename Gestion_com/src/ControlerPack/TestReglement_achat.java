...
public class TestReglement_achat extends JFrame implements MouseListener{
	Reglement_achatBase cdb=null; 
	
	JTable jtclient;
	JScrollPane jsp;

	public TestReglement_achat()
	{
...
public static void main(String []args)
{
	System.out.println("Debut de programme");
	 TestReglement_achat c=new TestReglement_achat();
	 c.setVisible(true);
...
public void mouseClicked(MouseEvent e) {
	...
	cdb.supprimerReglement_achat((int)cdb.mytablemodel.getValueAt(jtclient.getSelectedRow(),0));
