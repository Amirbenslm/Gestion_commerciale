...
public class TestBon_livraison_vente extends JFrame implements MouseListener{
Bon_livraison_venteBase cdb=null; 
	
	JTable jtclient;
	JScrollPane jsp;

	public TestBon_livraison_vente()
	{
		...
		this.setTitle("gestion des Bon_livraison_vente");
		...
		cdb=new Bon_livraison_venteBase();
		  ...
		  intitJtableClient();
			...
			ajout.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					Bon_livraison_vente f=new Bon_livraison_vente(1,"REference",1,5);
					cdb.AjoutBon_livraison_vente(f);
			...
			modifier.addActionListener(new ActionListener() {
				...
				@Override
				public void actionPerformed(ActionEvent e) {
					Bon_livraison_vente f=new Bon_livraison_vente(7,"REferenceModifier",1,5);
					cdb.ModifierBon_livraison_vente(f);
					}
			});
			this.setLayout(null);
...
public static void main(String []args)
{
	System.out.println("Debut de programme");
	 TestBon_livraison_vente c=new TestBon_livraison_vente();
	 c.setVisible(true);
...
public void mouseClicked(MouseEvent e) {
	...
	cdb.supprimerBon_livraison_vente((int)cdb.mytablemodel.getValueAt(jtclient.getSelectedRow(),0));
