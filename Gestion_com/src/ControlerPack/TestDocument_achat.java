...
public class TestDocument_achat extends JFrame implements MouseListener{
	Document_achatBase cdb=null; 
	
	JTable jtclient;
	JScrollPane jsp;

	public TestDocument_achat()
	{
		...
		this.setTitle("gestion des Document_achat");
		  ...
		  intitJtableClient();
			...
			ajout.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					Document_achat f=new Document_achat(0,"2017-07-12 00:00:00",47,47);
					cdb.AjoutDocument_achat(f);
			...
			modifier.addActionListener(new ActionListener() {
				...
				@Override
				public void actionPerformed(ActionEvent e) {
					Document_achat f=new Document_achat(1,"12-02-03",1,47);
					cdb.ModifierDocument_achat(f);
					}
			});
			this.setLayout(null);
...
public static void main(String []args)
{
	System.out.println("Debut de programme");
	 TestDocument_achat c=new TestDocument_achat();
	 c.setVisible(true);
...
public void mouseClicked(MouseEvent e) {
	...
	cdb.supprimerDocument_achat((int)cdb.mytablemodel.getValueAt(jtclient.getSelectedRow(),0));
